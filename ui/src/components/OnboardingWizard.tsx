...
export function OnboardingWizard() {
  ...
  const groupedModels = useMemo(() => {
    if (adapterType !== "opencode_local" && adapterType !== "openrouter_local") {
      return [
        {
          provider: "models",
                        ...
                        {[
                          ...
                          <button
                            ...
                            onClick={() => {
                              ...
                              if (nextType === "opencode_local" || nextType === "openrouter_local") {
                                if (!model.includes("/")) {
                                  setModel("");
                                }
                                return;
                            ...
                            <button className="inline-flex items-center gap-1.5 rounded-md border border-border px-2.5 py-1.5 text-sm hover:bg-accent/50 transition-colors w-full justify-between">
                              ...
                              >
                                {selectedModel
                                  ? selectedModel.label
                                  : model ||
                                    (adapterType === "opencode_local" || adapterType === "openrouter_local"
                        ...
                        <div className="rounded-md border border-border/70 bg-muted/20 px-2.5 py-2 text-[11px] space-y-1.5">
                          ...
                          {adapterType === "openrouter_local" ? (
                            <p className="text-muted-foreground">
                              Verify your OpenRouter API key is set in the adapter config.
                              Visit <span className="font-mono">https://openrouter.ai/keys</span> to manage keys.
                            </p>
                          ) : (
                            <>
